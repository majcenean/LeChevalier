...
//How large should the I key image be
var instructPgWH = 200;

// Mouse boundary; how far should the user have to move their mouse, and where should the indication appear (what is width divided by)
...
// Splash text drawn in the splash states and in the end states
...
// Dialogue text drawn in the action states
...
// Drawing the different options to reject or accept, called in the letter and action states
...
// Drawing the letter image on the letter states depending on the X position of the user's mouse
function drawLetter() {
    for (i = 0; i <= 5; i++) {
...
// Drawing the written contents of the letter
...
// Drawing the "Press I for instructions" message in the letter states
